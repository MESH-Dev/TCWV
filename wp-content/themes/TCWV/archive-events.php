...
<div class="container content">
    ...
    <div id="blogmain" class="row" style="position: relative;  width:1040px; z-index: 10;  overflow-y: hidden; height: 2263px; left:-10px;">
      ...
      <!--FUTURE-->
         ...
         <div class="span6 left <?php echo 'b'.$num ?>">
			  <div class="box">
